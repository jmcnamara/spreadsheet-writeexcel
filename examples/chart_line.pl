...
#
my $chart1 = $workbook->add_chart( name => 'Chart1', type => 'line' );
...
#            and a series name.
#
my $chart2 = $workbook->add_chart( name => 'Chart2', type => 'line' );
...
#
my $chart3 = $workbook->add_chart( name => 'Chart3', type => 'line' );
...
#
my $chart4 = $workbook->add_chart( name => 'Chart4', type => 'line' );
...
#
my $chart5 = $workbook->add_chart( embedded => 1, type => 'line' );
