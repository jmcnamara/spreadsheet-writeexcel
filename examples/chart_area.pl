...
#
my $chart1 = $workbook->add_chart( name => 'Chart1', type => 'area' );
...
#            and a series name.
#
my $chart2 = $workbook->add_chart( name => 'Chart2', type => 'area' );
...
#
my $chart3 = $workbook->add_chart( name => 'Chart3', type => 'area' );
...
#
my $chart4 = $workbook->add_chart( name => 'Chart4', type => 'area' );
